...
class TestApi(unittest.TestCase):
    ...
    def test_add_user(self):  # # adds this user, tries to add the same user twice, then checks if they got added.
    ...
    def test_user_authentication(
            self):  # checks correct account, then wrong pass, then wrong username, then parameters without username, or password.
